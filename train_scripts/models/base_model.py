...
class BaseModel(object):
    ...
    def build_save(self):
        ...
        inputs = {
            'training': tf.saved_model.utils.build_tensor_info(self.training),
            'labels': tf.saved_model.utils.build_tensor_info(self.labels),
            'seq_word_left': tf.saved_model.utils.build_tensor_info(self.seq_word_left),
            'seq_word_right': tf.saved_model.utils.build_tensor_info(self.seq_word_right),
            'seq_char_left': tf.saved_model.utils.build_tensor_info(self.seq_char_left),
            'seq_char_right': tf.saved_model.utils.build_tensor_info(self.seq_char_right),
            'seq_len_word_left': tf.saved_model.utils.build_tensor_info(self.seq_len_word_left),
            'seq_len_word_right': tf.saved_model.utils.build_tensor_info(self.seq_len_word_right),
            'seq_len_char_left': tf.saved_model.utils.build_tensor_info(self.seq_len_char_left),
            'seq_len_char_right': tf.saved_model.utils.build_tensor_info(self.seq_len_char_right),
            'features': tf.saved_model.utils.build_tensor_info(self.features)
        }
        output = {"output": tf.saved_model.utils.build_tensor_info(self.proba)}
